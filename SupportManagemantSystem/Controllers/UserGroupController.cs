...
namespace SupportManagemantSystem.Controllers
{
    ...
    public class UserGroupController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "userGroupID,name")] UserGroup userGroup)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "userGroupID,name")] UserGroup userGroup)
        {
            if (ModelState.IsValid)
            {
